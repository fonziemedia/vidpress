<!-- The loop for our latest posts -->
<?php
$cat_id = $_POST[ 'cat' ]; // obtaining the cat id from the categories DOM element @ index.php, this is passed by the loadCatPages(pageNumber, cat, countedPages) jquery function in our footer
$page_number = $_POST[ 'page_no']; // obtaining the counted_pages number from the on click #next-cat-btn jquery function, this is also passed by the loadCatPages(pageNumber, cat, countedPages) jquery function in our footer
	global $wp_query, $paged;
						...
						<div class="col-md-12">
						<button type="button" id="next-cat-btn" class="btn btn-primary pagination" pagesvalue="<?php echo $total_pages;?>" catvalue="<?php echo $cat_id;?>">
